...
public:
    ...
    void setupUi(QWidget *UserLoginWindow)
    {
        ...
        UserLoginWindow->resize(626, 513);
        back = new QPushButton(UserLoginWindow);
        back->setObjectName(QString::fromUtf8("back"));
        back->setGeometry(QRect(260, 380, 93, 28));
...
"background-color:#34495e;"));
    ...
    {
        UserLoginWindow->setWindowTitle(QApplication::translate("UserLoginWindow", "\347\224\250\346\210\267\347\231\273\345\275\225", nullptr));
