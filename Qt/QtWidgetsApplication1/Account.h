...
public:
	...
	void readAllCourier(vector<string>& courierList, string company);					//读取对应所有快递员													//输出单个快递信息
	...
	static QString sToq(string s);//Qstring转string
	static string qTos(QString s);//string转Qstring
